...
function Eventos() {
  ...
  const ModalFields = (form: typeof addForm | typeof editForm, setForm: React.Dispatch<React.SetStateAction<any>>) => {
    ...
    const capMaxPlanta = plantaActual && idBuilding
      ...
      <>
        ...
        {plantaActual && (
          <>
            ...
            <select style={inputStyle} value={form.id_aula}
              ...
              <table className="data-table">
                <thead>
                  <tr>
                    ...
                    <th>Usuario</th><th>Status</th><th></th>
                  </tr>
                </thead>
                <tbody>
                  {filteredEventos.map(ev => (
                    <tr key={ev.id_event}>
                      ...
                      <td><PlantaCell planta={ev.aulas?.planta ?? null} capacidad={ev.aulas?.capacidad ?? ev.capacidad_esperada ?? 0} /></td>
